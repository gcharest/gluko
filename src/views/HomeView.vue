        ...
        <div class="row g-4 py-4">
          ...
          <div class="col-md-6">
            <div class="card h-100">
              <div class="card-body">
                <h2 class="card-title h4">{{ $t('components.mealCalculator.title') }}</h2>
                <p class="card-text">{{ $t('aboutText.para2') }}</p>
                <button class="btn btn-primary w-100" @click="navigateTo('/calculator')">
                  {{ $t('navigation.home') }}
                </button>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="card-text">
                  {{ $t('aboutText.para3') }}
                  <a :href="$t('aboutText.url')" target="_blank"> {{ $t('aboutText.CNF') }} </a>.
                </p>
