...
<template>
  ...
  <header class="navbar navbar-expand-lg sticky-top bg-primary bg-gradient">
    <nav class="container-xxl flex-wrap flex-lg-nowrap" :aria-label="mainNavigationBarAriaLabel">
      <RouterLink class="navbar-brand" to="/">Gluko</RouterLink>
      <button class="navbar-toggler p-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbarMain"
        aria-controls="navbarMain" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div id="navbarMain" class="offcanvas-lg offcanvas-end flex-grow-1" tabindex="-1"
        aria-labelledby="mainNavbarOffCanvas" data-bs-scroll="true">
        <div class="offcanvas-header px-4 pb-0">
          <h1 class="display-5 offcanvas-title">Gluko</h1>
          <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#navbarMain"
        ...
        <div class="offcanvas-body p-4 pt-0 p-lg-0">
          <ul class="navbar-nav flex-row flex-wrap fw-bold">
            ...
            <li class="nav-item col-12 col-lg-auto mb-lg-1" data-bs-dismiss="offcanvas" data-bs-target="#navbarMain">
              <RouterLink class="nav-link" to="/carb-factor">{{ $t('navigation.carbFactor') }}</RouterLink>
            </li>
            <li class="nav-item col-12 col-lg-auto mb-lg-1" data-bs-dismiss="offcanvas" data-bs-target="#navbarMain">
          ...
          <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
            <li class="nav-item col-6 col-lg-auto">
              <a class="nav-link py-2 px-0 px-lg-2" href="https://github.com/gcharest/gluko" target="_blank"
                rel="noopener">
