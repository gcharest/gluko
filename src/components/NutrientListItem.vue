...
<template>
  <div class="card mb-3" :aria-label="$t('components.nutrientList.item.title', { index: props.index + 1 })">
    ...
    <div class="card-body p-2">
      <div class="row gx-5">
        <div class="col-6 col-lg-3 text-center mb-1 mb-lg-0 mt-md-3">
          <p id="quantity-label-{{props.nutrient.id}}" class="mb-1">{{ $t('common.labels.quantity') }}:</p>
          <p class="mb-1 mb-md-3" aria-labelledby="quantity-label-{{props.nutrient.id}}">
            {{ props.nutrient.quantity }} {{ $t('common.units.grams') }}
          </p>
        </div>
        <div class="col-6 col-lg-3 text-center mb-1 mb-lg-0 mt-md-3">
          <p id="factor-label-{{props.nutrient.id}}" class="mb-1">{{ $t('common.labels.factor') }}:</p>
        ...
        <div class="col-md-12 col-lg-2 text-center mb-1 mb-md-0 mt-md-3">
          <p id="subtotal-label-{{props.nutrient.id}}" class="mb-1">{{ $t('common.labels.subtotal') }}:</p>
...
type="button" class="btn btn-primary w-100 py-1 py-md-2"
                ...
                tabindex="0" @click="emit('modifyCurrentNutrient', props.nutrient.id)" @keydown="handleModifyKeydown">
