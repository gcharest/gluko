...
This directory contains detailed technical specifications and implementation guides. Each document corresponds to a release planning document and includes:
...
- Overview and link to release planning document
- Architecture and data flow diagrams
- API specifications and types
...
- Release planning: [../releases/](../releases/)
